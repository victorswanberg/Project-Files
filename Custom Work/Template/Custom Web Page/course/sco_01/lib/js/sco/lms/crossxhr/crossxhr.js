...
var flashhttpRequest_debug = false;
if (typeof (FlashHttpRequest_counter) == 'undefined') {
    ...
    */
    ...
    //var SWF_URL = "http://www.foo.com/lib/crossxhr.swf"; // set if you want to hardcode path to crossxhr.swf
    ...
    function FlashHttpRequest_handler(id, status, data) {
        if (flashhttpRequest_debug) {
            alert('FlashHttpRequest_handler status: ' + status + ' data: ' + data);
        }
    ...
    function CrossXHR() {
        ...
        this.open = function (arg1, arg2) {
            if (flashhttpRequest_debug) {
                alert('open arg1: ' + arg1 + ' arg2: ' + arg2);
            }
            if (obj)
                obj.open(arg1, arg2);
            else {
    ...
    $(document).ready(function () {
        if (flashhttpRequest_debug) {
            alert('writing in swfobject. SWF_URL:' + SWF_URL);
        }

        $('<span style="position:absolute;top:0;left:0;width:0;height:0;overflow:hidden"><span id="FlashHttpRequest_gateway"></span></span>').appendTo('body');
        //window.setTimeout(function () { swfobject.embedSWF(SWF_URL, "FlashHttpRequest_gateway", "1", "1", "9.0.0", "expressInstall.swf", {}, { wmode: 'opaque', allowscriptaccess: "always" }) }, 2000);
        swfobject.embedSWF(SWF_URL, "FlashHttpRequest_gateway", "1", "1", "9.0.0", "expressInstall.swf", {}, { wmode: 'opaque', allowscriptaccess: "always" });
    });
}
